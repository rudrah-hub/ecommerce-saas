                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-grid text-1xs">
                                                <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                    <i class="fa fa-square text-primary text-opacity-10 me-1"></i> Follow-ups
                                                </div>
                                                <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                    <i class="fa fa-square text-primary text-opacity-25 me-1"></i> In Progress
                                                </div>
                                                <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                    <i class="fa fa-square text-primary text-opacity-50 me-1"></i> Pending
                                                </div>
                                            </div>
                        ...
                        <i class="fi fi-bs-menu-dots"></i>
                                    ...
                                    <div class="card-body pt-0">
                                        ...
                                        <div class="d-grid gap-1">
                                            <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                <i class="fa fa-square text-primary text-opacity-10 me-1"></i> Organic Search
                                                <strong class="text-dark fw-semibold ms-auto">41.50%</strong>
                                            </div>
                                            <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                <i class="fa fa-square text-primary text-opacity-25 me-1"></i> Direct Traffic
                                                <strong class="text-dark fw-semibold ms-auto">27%</strong>
                                            </div>
                                            <div class="d-flex gap-1 align-items-center py-1 mx-1">
                                                <i class="fa fa-square text-primary text-opacity-50 me-1"></i> Referral Traffic
                                                <strong class="text-dark fw-semibold ms-auto">18%</strong>
                                            </div>
                                            <div class="d-flex gap-1 align-items-center py-1 py-1 mx-1">
                                                <i class="fa fa-square text-primary text-opacity-75 me-1"></i> Social Media
